...
testbtn.addEventListener("click", function fillInTesting() {
  document.querySelector("#useremail").value = "test@test.com";
  document.querySelector("#userpassword").value = "testing";
  signinbe();
});
...
const skeleton_text_shortDescription = document.querySelector(
  ".skeleton_text_shortDescription"
);
...
window.addEventListener("load", function () {
  ...
  if (skeleton_text_shortDescription) {
    skeleton_text_shortDescription.classList.remove(
      "skeleton_text_shortDescription"
    );
  }
